...
public class MainActivityClickTest {
    ...
    public void clickDecrementButton_ChangesQuantityAndCost() {
        ...
        onView(withId(R.id.recipeNameDetails_tv)).check(matches(withText("Nutella Pie")));
        onView(withId(R.id.recipe_iv)).check(matches(withTagValue(Matchers.<Object>equalTo(R.drawable.nutellapie))));
